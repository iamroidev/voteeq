...
export const ACSES_AWARD_CATEGORIES = [
  ...
  'Most Dedicated Executive of the Year',
  'Course Representative of the Year',
  'Student Leader of the Year',
  'Leadership Excellence Award',
  'Best Programmer of the Year',
  'Best Cybersecurity Talent of the Year',
  'Best Information Systems Talent of the Year',
  'Best Robotics Talent of the Year',
  'Best UI/UX Talent of the Year',
  ...
  'Most Innovative Freshman of the Year',
  'Most Popular Freshman (Male)',
  'Most Popular Freshman (Female)',
  'Gentleman of the Year',
  'Lady of the Year',
  'Face of ACSES (Male)',
  'Face of ACSES (Female)',
  'Most Photogenic Male Student of the Year',
  'Most Photogenic Female Student of the Year',
