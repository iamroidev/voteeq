      ...
      <div className="editorial-sheet" style={{ padding: '3rem' }}>
        ...
        <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
            <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: 'var(--text-primary)' }}>Online Voting:</strong> Use our web portal to vote via mobile money (MTN, Telecel, AirtelTigo). Rate: GHS 1.00 per vote.</li>
            <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: 'var(--text-primary)' }}>USSD Shortcode:</strong> Dial *920*102# on your mobile phone to vote via USSD. Rate: GHS 0.50 per vote.</li>
          </ul>
