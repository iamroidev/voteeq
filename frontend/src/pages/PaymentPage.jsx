    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 0' }}>
      ...
      <div className="editorial-sheet" style={{ padding: '3rem' }}>
        ...
        <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
          ...
          <p style={{ marginBottom: '1.5rem' }}>
            All payments are processed through <strong style={{ color: 'var(--text-primary)' }}>Paystack</strong>, a PCI-DSS Level 1 certified payment processor. This is the highest level of certification in the payments industry, ensuring your financial data is always encrypted and secure.
          </p>
          ...
          <div style={{ marginTop: '2rem', padding: '1.5rem', background: 'var(--accent-light)', borderRadius: '8px', borderLeft: '3px solid var(--accent)' }}>
            <p style={{ fontSize: '0.85rem', color: 'var(--accent-dark)', fontWeight: 500 }}>
              💳 Payment processing powered by <strong>Paystack</strong> — PCI-DSS Level 1 Certified
            </p>
          </div>
        </div>
      </div>
